...
public class PointView extends View {
    ...
    public static final float RADIUS = Utils.dpToPixel(25);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawCircle(innerPaddingLeft + RADIUS + width * position.x, innterPaddingTop + RADIUS + height * position.y, RADIUS, mPaint);
    }
